...
module.exports = {
    ...
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'https://i.imgur.com/8lSlNhI.jpeg' : process.env.GAN_IMAGE,
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'ᴍᴀᴅᴇ ʙʏ ɴɪʏᴀᴍᴡᴏʟ' : process.env.ALL_CAPTION,
    ...
    BOTNAME: process.env.BOT_NAME === undefined ? '  ☚⃟፝༄𝙽𝙸𝚈𝙰𝙼𝚆𝙾𝙻☚⃟፝࿐  \n\n   *ωнαтsαρρ вσт™*   \n' : process.env.BOT_NAME,
    NOLOG: process.env.NO_LOG === undefined ? 'false' : process.env.NO_LOG,
    THERI_KICK: process.env.THERI_KICK === undefined ? 'false' : process.env.THERI_KICK,
    SONGD: process.env.SONGD === undefined ? '𝙽𝙸𝚈𝙰𝙼𝚆𝙾𝙻 Download' : process.env.SONGD,
    SONGU: process.env.SONGU === undefined ? '𝙽𝙸𝚈𝙰𝙼𝚆𝙾𝙻 Uploading' : process.env.SONGU,
    ...
    YAK: process.env.YAK === undefined ? '919037601967,0' : process.env.YAK,
    OWNERSHIP: process.env.OWNER_SHIP === undefined ? '𝙽𝙸𝚈𝙰𝙼𝚆𝙾𝙻' : process.env.OWNER_SHIP,
    LOGO: process.env.LOGO_LINK === undefined ? 'https://i.imgur.com/8lSlNhI.jpeg' : process.env.LOGO_LINK,
    BOTV2: process.env.BOTV2_NAME === undefined ? '𝙽𝙸𝚈𝙰𝙼𝚆𝙾𝙻' : process.env.BOTV2_NAME,
